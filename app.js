...
(function() {
  ...
  if (brand) {
    ...
    brand.addEventListener('click', () => {
      taps++;
      if (taps >= 5) {
        window.open('https://www.youtube.com/watch?v=1qN72LEQnaU', '_blank');
        const toast = document.createElement('div');
        toast.textContent = '🐹 HAMSTER DANCE! 🐹';
        toast.style.cssText = 'position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:#2dd4bf;color:#000;padding:20px 32px;border-radius:16px;font-size:24px;font-weight:800;z-index:10000;box-shadow:0 20px 60px rgba(45,212,191,0.5)';
